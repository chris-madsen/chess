...
| ADR | Status | Decision |
|---|---|---|
| ADR-001 | Accepted | Preserve human-in-the-loop decision making |
| ADR-002 | Accepted | Make move provenance mandatory and explicit |
| ADR-003 | Accepted | Use hybrid human-path scenario-line orchestration |
| ADR-004 | Accepted | Isolate engines, manage licenses, and protect secrets |
