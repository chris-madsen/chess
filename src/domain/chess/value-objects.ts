...
export type ZobristPositionKey = Brand<string, "ZobristPositionKey">;
export type HistorySignature = Brand<string, "HistorySignature">;
export type ProviderConfigFingerprint = Brand<string, "ProviderConfigFingerprint">;
export type PatternModelVersion = Brand<string, "PatternModelVersion">;
...
export const makeZobristPositionKey = (value: string): ZobristPositionKey => brandString<"ZobristPositionKey">(value);
export const makeHistorySignature = (value: string): HistorySignature => brandString<"HistorySignature">(value);
export const makeProviderConfigFingerprint = (value: string): ProviderConfigFingerprint => brandString<"ProviderConfigFingerprint">(value);
export const makePatternModelVersion = (value: string): PatternModelVersion => brandString<"PatternModelVersion">(value);
